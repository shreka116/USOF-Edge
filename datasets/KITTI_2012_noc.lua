...
local M = {}
local KITTI_2012_nocDataset = torch.class('USOF.KITTI_2012_nocDataset', M)

function KITTI_2012_nocDataset:__init(imageInfo, opt, split)
...
function KITTI_2012_nocDataset:get(i)
   ...
   local image_flow = readPNGFlowFile(path_flow)
...
function KITTI_2012_nocDataset:_loadImage(path)
...
function KITTI_2012_nocDataset:size()
...
function KITTI_2012_nocDataset:preprocess()
...
return M.KITTI_2012_nocDataset
